...
import * as CredentialData from "@/features/credential/data";
import { InvitationDeleteButton } from "@/features/invitations/components/invitation-delete-button";
...
const CredentialList = async ({ organizationId }: CredentialListProps) => {
  const credentials = await CredentialData.getCredentials(organizationId);
